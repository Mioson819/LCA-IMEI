...
namespace LCA_Project.Form
{
    public partial class frmControl : System.Windows.Forms.Form
    {
        ...
        public frmControl(string namePort, KeyenceHostLinkTcpClient plc)
        {
            InitializeComponent();
            _namePort = namePort;
            _plc = plc;
        ...
        private int DataTypeTextBox(string input, string tag)
        {
            ...
            else if (ContainsAny(input, "Time", "AngeRO") && tag != null && tag != string.Empty)
            {
                return 1;
            }
            else
        ...
        private DataTypeEvent DataTypeButton(string input, string tag)
        {
            ...
            else if (ContainsAny(input, "JOG", "RESET", "ORG", "RqMP", "RqOpenSK", "RqCloseSK") && tag != null && tag != string.Empty)
            {
        ...
        private void tableLayoutPanel139_Paint(object sender, PaintEventArgs e)
        {
        }
        private void RqSensorDoor_Click(object sender, EventArgs e)
        {
        }
    }
}